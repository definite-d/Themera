...
# taken up by the icon (alone) in Base64 form. Thanks to PEP-8. Nuh-uh; I'm NOT filling paragraph, PyCharm.
...
def random_color():
    ...
    color = rc([color, colour.Color(sg.GetComplimentaryHex(color)).get_web()])
    if DebugMode is on:
...
while True:
    ...
    if window_1_events is 'gen':
        ...
        if ' ' in str(window_1_values['name']):
            sg.Popup('Spaces aren\'t allowed in theme names. They will be automatically removed.', title='No spaces allowed!',
            button_type = 'Cancel', location = (window_1_c[0] + 90, window_1_c[1] + 50))
            window_1_values['name'] = str(window_1_values['name']).replace(' ', '')
            ...
            if unspecified is True:
                ...
                while True:
                    try:
                        ...
                        if unspec_opts_events is 'Confirm':
            ...
            if done:  # Yep. Real shameless signal system.
                ...
                if window_1_values['dark'] is True:
                    ...
                    theme = theme + str(f'# Custom {name} - Dark LookAndFeel Theme.\n'
                                        ...
                                        f'#sg.ChangeLookAndFeel(\'{name}Dark\')\n\n')
                if window_1_values['light'] is True:
                    light_list = [sorted_list[7], sorted_list[1], sorted_list[0],
                                  sorted_list[6], sorted_list[5], sorted_list[0],
                                  sorted_list[6], sorted_list[4]]
                    ...
                    theme = theme + str(f'# Custom {name} - Light LookAndFeel Theme.\n'
                                        ...
                                        f'#    \'SLIDER_DEPTH\': {str(sl_bor_w)},\n'
                                        f'#    \'PROGRESS_DEPTH\': {str(pb_w)}}}\n\n'
                                        f'#sg.ChangeLookAndFeel(\'{name}Light\')\n\n')
                if window_1_values['grayout'] is True:
                    ...
                    theme = theme + str(f'# Custom {name} - Gray LookAndFeel Theme.\n'
                                        ...
                                        f'#    \'SLIDER_DEPTH\': {str(sl_bor_w)},\n'
                                        f'#    \'PROGRESS_DEPTH\': {str(pb_w)}}}\n\n'
                                        f'#sg.ChangeLookAndFeel(\'{name}Gray\')\n\n')
