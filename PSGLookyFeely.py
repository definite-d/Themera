...
if sg.LOOK_AND_FEEL_TABLE[random_theme]['PROGRESS'] == sg.DEFAULT_PROGRESS_BAR_COLOR:
    sg.LOOK_AND_FEEL_TABLE[random_theme]['PROGRESS'] = (sg.LOOK_AND_FEEL_TABLE[random_theme]['TEXT'],
                                                        sg.LOOK_AND_FEEL_TABLE[random_theme]['INPUT'])
    # sg.LOOK_AND_FEEL_TABLE[random_theme]['PROGRESS'] = sg.LOOK_AND_FEEL_TABLE[random_theme]['BUTTON']
...
window_1 = sg.Window(('LookyFeely'+' - v1.9.2'), layout=window_1_layout, element_justification='center',
                ...
                if output_window_events in 'preview':
                    try:
                        ...
                        if user_output != theme:    # output panel.
                            ...
                            exec(theme)             # Nice for adjusting the background color in a pinch.
                        ...
                        sg.ChangeLookAndFeel(random_theme)
                            ...
                            sg.Popup('An error occured! Please check your entries! You may have typed in an unsupported '
                                     'character or put in a wrong color value format.',
                                           title='Error!')
                            if DebugMode is on:
                                print('Error!')
...
# Well, that's all people. Just over 280 lines total. Comments included.
