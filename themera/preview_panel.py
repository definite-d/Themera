...
class PreviewPanel:
    """
    This class handles the functionality behind the way the preview panel (for selecting images)
    works, and acts as a validator for said images, since if it previews, it'll work for our
    purposes.
    """
